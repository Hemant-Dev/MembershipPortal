...
namespace MembershipPortal.IRepositories
{
    public interface ISubscriptionRepository : IRepository<Subscription>
    {
        ...
        Task<(IEnumerable<Subscription>, int)> GetAllPaginatedSubscriptionsAsync(string? sortColumn, string? sortOrder, int page, int pageSize, Subscription subscription);
    }
}
